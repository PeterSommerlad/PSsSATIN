...
static_assert(max_64 + v1_64 == max_64 );
static_assert(max_64 + v1_32 == max_64 );
static_assert(max_64 + v1_16 == max_64 );
static_assert(max_64 + v1_8  == max_64 );
static_assert(max_32 + v1_64 == 0x8000'0000_ssi64 );
static_assert(max_32 + v1_32 == max_32 );
static_assert(max_32 + v1_16 == max_32 );
static_assert(max_32 + v1_8  == max_32 );
static_assert(max_16 + v1_64 == 0x8000_ssi64 );
static_assert(max_16 + v1_32 == 0x8000_ssi32 );
static_assert(max_16 + v1_16 == max_16 );
static_assert(max_16 + v1_8  == max_16 );
static_assert(max_8  + v1_64 == 128_ssi64 );
static_assert(max_8  + v1_32 == 128_ssi32 );
static_assert(max_8  + v1_16 == 128_ssi16 );
static_assert(max_8  + v1_8  == max_8 );
...
// demonstrate saturation: (see below)
static_assert(min_64 * v2_64 == min_64 );
static_assert(min_64 * v2_32 == min_64  );
static_assert(min_64 * v2_16 == min_64  );
static_assert(min_64 * v2_8  == min_64 );
static_assert(min_32 * v2_64 == -0x1'0000'0000_ssi64 );
static_assert(min_32 * v2_32 == min_32 );
static_assert(min_32 * v2_16 == min_32 );
static_assert(min_32 * v2_8  == min_32 );
static_assert(min_16 * v2_64 == -0x1'0000_ssi64  );
static_assert(min_16 * v2_32 == -0x1'0000_ssi32 );
static_assert(min_16 * v2_16 == min_16 );
static_assert(min_16 * v2_8  == min_16 );
static_assert(min_8  * v2_64 == -256_ssi64 );
static_assert(min_8  * v2_32 == -256_ssi32 );
static_assert(min_8  * v2_16 == -256_ssi16 );
static_assert(min_8  * v2_8  == min_8 );
...
// demonstrate saturation:
static_assert(min_64 / vminus1_64 == max_64 );
static_assert(min_64 / vminus1_32 == max_64 );
static_assert(min_64 / vminus1_16 == max_64 );
static_assert(min_64 / vminus1_8  == max_64 );
...
static_assert(min_8  / vminus1_8  == max_8 );
...
check_does_compile(   ,  sui8 , + (1_sui8 << 010_sui8) + ) // too wide shift OK saturating
...
check_does_compile(   ,  sui8 , + (0x80_sui8 >> 010_sui8) + ) // too wide shift OK saturating
...
check_does_compile(   ,  sui8 , / ) // div OK when saturating
check_does_compile(   ,  sui8 , +( 1_sui8  / 1_sui8)+ ) // div
check_does_compile(   ,  sui8 , % ) // mod OK when saturating
check_does_compile(   ,  sui8 , +( 11_sui8  % 3_sui8)+ ) // mod
check_does_compile(not,  sui8 , + 1_ssi8 + ) // mixed
check_does_compile(   ,  sui8 , + 255_sui8 + 1_sui8 + ) // overflow detect OK saturating
static_assert(std::numeric_limits<sui8>::max() == 128_sui8 * 128_sui8); // overflow
check_does_compile(   ,  sui8 , + 128_sui8 * 128_sui8 +) // overflow detect OK saturating
static_assert(std::numeric_limits<ssi8>::max() == 64_ssi8 * 2_ssi8); // overflow
check_does_compile(   ,  ssi8 , + 64_ssi8 * 2_ssi8 +) // overflow detect OK saturating
static_assert(std::numeric_limits<ssi8>::max() == (-127_ssi8 - 1_ssi8) * -1_ssi8); // saturating
check_does_compile(   ,  ssi8 , + (-127_ssi8 - 1_ssi8) * -1_ssi8 +) // overflow detect OK saturating
check_does_compile(   ,  ssi8 , + (-127_ssi8 - 1_ssi8) * 1_ssi8 +) // no overflow
static_assert(std::numeric_limits<ssi8>::max()==(-127_ssi8 - 1_ssi8) / -1_ssi8);
check_does_compile(   ,  ssi8 , + (-127_ssi8 - 1_ssi8) / -1_ssi8 +) // overflow detect OK saturating
check_does_compile(   ,  ssi8 , + (-127_ssi8 - 1_ssi8) / 1_ssi8 +) // no overflow
...
// demonstrate saturation almost everything compiles in contrast to overflow:
static_assert(max_64 == min_64 / vminus1_64); // negation by /-1 works
static_assert(max_64 == min_64 / vminus1_32); // negation by /-1 works
static_assert(max_64 == min_64 / vminus1_16); // negation by /-1 works
static_assert(max_64 == min_64 / vminus1_8);  // negation by /-1 works
...
static_assert(min_32 / vminus1_64 == 0x8000'0000_ssi64 );
static_assert(max_32 == min_32 / vminus1_32);
static_assert(max_32 == min_32 / vminus1_16);
static_assert(max_32 == min_32 / vminus1_8);
...
static_assert(min_8  / vminus1_32 == 128_ssi32 );
static_assert(min_8  / vminus1_16 == 128_ssi16 );
static_assert(max_8 == min_8 / vminus1_8);
...
static_assert(min_64 == min_64 * v2_64); // saturating
//check_does_compile(not,  ssi64 , + min_64 * v2_64 +) // overflow detect
static_assert(min_64 == min_64 * v2_32); // saturating
//check_does_compile(not,  ssi64 , + min_64 * v2_32 +) // overflow detect
static_assert(min_64 == min_64 * v2_16); // saturating
//check_does_compile(not,  ssi64 , + min_64 * v2_16 +) // overflow detect
static_assert(min_64 == min_64 * v2_8);  // saturating
...
static_assert(promote_keep_signedness(0xffff_sui16 * 0xffff_sui16) == 0xffffu); // saturates
static_assert(maxu_8 == 0xff_sui8 * 0xff_sui8);
//check_does_compile(not,  sui8 , + 0xff_sui8 * 0xff_sui8 +) // overflow detect
static_assert(0xff_sui8 * 0xff_sui8 == 0xff_sui8); // saturates
...
static_assert(0_sui64 == maxu_64 >> maxu_64);

// the following does not compile due to signed integer overflow on 32bit int
//static_assert(static_cast<uint16_t>(0xffffu)* static_cast<uint16_t>(0xffffu));

check_does_compile(   ,  ssi32 , + 0x7fff'ffff_ssi32+2_ssi32 +) // saturation compiles
static_assert(0x7fff'ffff_ssi32+2_ssi32 == 0x7fff'ffff_ssi32);
//static_assert(0x7fff'ffff + 2); // doesn't compile, integer overflow
static_assert(std::numeric_limits<ssi32>::min() == (-0x7fff'ffff_ssi32 - 2_ssi32));
check_does_compile(   ,  ssi32 , + (-0x7fff'ffff_ssi32 - 2_ssi32) +) // overflow detect
static_assert(-0x7fff'ffff_ssi32 - 2_ssi32 == std::numeric_limits<ssi32>::min());
//static_assert(-0x7fff'ffff - 2); // doesn't compile, integer overflow
